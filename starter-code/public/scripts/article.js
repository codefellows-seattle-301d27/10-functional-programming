...
// Where the IIFE is invoked, pass in the global 'app' object that is defined above. DONE
(function(module){
  ...
  Article.loadAll = rows => {
    ...
    // There is no need to push to anything. DONE
  ...
  */
  ...
  // probably need to use the optional accumulator argument in your reduce call. DONE
  Article.allAuthors = () => {
